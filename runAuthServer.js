...
expressApp.get('/callback/amazon', (req, resp) => {
    getToken('amazon', {code: req.query.code})
        .then(r => {
            resolve({company: 'amazon', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'amazon', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
expressApp.get('/callback/discord', (req, resp) => {
    getToken('discord', {code: req.query.code})
        .then(r => {
            resolve({company: 'discord', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'discord', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
expressApp.get('/callback/facebook', (req, resp) => {
    getToken('facebook', {code: req.query.code})
        .then(r => {
            resolve({company: 'facebook', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'facebook', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
expressApp.get('/callback/github', (req, resp) => {
    getToken('github', {code: req.query.code}, {headers: {Accept: 'application/json'}})
        .then(r => {
            resolve({company: 'github', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'github', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
expressApp.get('/callback/google', (req, resp) => {
    getToken('google', {code: req.query.code})
        .then(r => {
            resolve({company: 'google', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'google', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
expressApp.get('/callback/microsoft', (req, resp) => {
    getToken('microsoft', {code: req.query.code})
        .then(r => {
            resolve({company: 'microsoft', data: r, responseObject: resp, requestObject: req})
        })
        .catch(err => {
            if(error){
                reject({company: 'microsoft', error: r, responseObject: resp, requestObject: req})
            }
        })
})
...
module.exports = {runAuthServer, expressApp}
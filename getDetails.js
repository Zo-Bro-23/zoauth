...
async function amazon(options, config = {}){
    ...
    return new Promise((resolve, reject) => {
        axios.get('https://api.amazon.com/user/profile', {...{headers: {Authorization: `${final.token_type} ${final.access_token}`}}, ...config})
...
async function discord(options, config = {}){
    ...
    const final = {...defaultOptions, ...options}  
    return new Promise((resolve, reject) => {
        axios.get('https://discord.com/api/oauth2/@me', {...{headers: {Authorization: `${final.token_type} ${final.access_token}`}}, ...config})
            .then(r => {resolve(r.data)})
            .catch(r => {resolve(r.response.data)})
        }) 
}
...
async function facebook(options, config = {}){
    const defaultOptions = {fields: "id, name"}
    const final = {...defaultOptions, ...options}
    return new Promise((resolve, reject) => {
        axios.get('https://graph.facebook.com/me', {...{params: {fields: final.fields, access_token: final.access_token}}, ...config})
            .then(r => {resolve(r.data)})
            .catch(r => {resolve(r.response.data)})
        })    
}
...
async function github(options, config = {}){
    ...
    const final = {...defaultOptions, ...options}
    return new Promise((resolve, reject) => {
        axios.get('https://api.github.com/user', {...{headers: {Authorization: `${final.token_type} ${final.access_token}`}}, ...config})
            .then(r => {resolve(r.data)})
            .catch(r => {resolve(r.response.data)})
        })    
}
...
async function google(options, config = {}){
    ...
    const final = {...defaultOptions, ...options}
    return new Promise((resolve, reject) => {
        axios.get('https://www.googleapis.com/oauth2/v1/userinfo', {...{headers: {Authorization: `${final.token_type} ${final.access_token}`}}, ...config})
            .then(r => {resolve(r.data)})
            .catch(r => {resolve(r.response.data)})
        })    
}
...
async function microsoft(options, config = {}){
    ...
    const final = {...defaultOptions, ...options}
    return new Promise((resolve, reject) => {
        axios.get('https://graph.microsoft.com/oidc/userinfo', {...{headers: {Authorization: `${final.token_type} ${final.access_token}`}}, ...config})
            .then(r => {resolve(r.data)})
            .catch(r => {resolve(r.response.data)})
        })
}
